...
export const constantRouterMap = [
  ...
  { path: '/login', component: () => import('@/views/login'), name: '登录微校', hidden: true },
    ...
    children: [
      {
        path: 'list-manage',
        name: 'list-manage',
        component: () => import('@/views/admin/list-manage'),
        meta: { title: 'adminList', icon: 'user', roles: ['admin'] }
      },
      {
        path: 'permission-manage',
        name: 'permission-manage',
        component: () => import('@/views/admin/permission-manage'),
        meta: { title: 'adminPermission', icon: 'eye', roles: ['admin'] }
      }
    ]
  },
  {
    ...
    meta: {
      title: 'studentManage',
      icon: 'peoples',
      roles: ['student', 'primary']
    },
    children: [{
      path: 'studentList-manage',
      name: 'studentList-manage',
      component: () => import('@/views/student/student-list'),
      meta: { title: 'studentList', icon: 'peoples', roles: ['student', 'primary'] }
    }]
  },
  {
    path: '/report',
    ...
    meta: {
      title: 'reportManage',
      icon: 'message',
      roles: ['primary', 'content', 'activity', 'hot', 'student']
    },
    children: [{
      path: 'reportList-manage',
      name: 'reportList-manage',
      component: () => import('@/views/report/report-list'),
      meta: { title: 'reportList', icon: 'message', roles: ['primary', 'content', 'activity', 'hot', 'student'] }
    }]
  },
  {
    path: '/hotspot',
    component: Layout,
    redirect: '/hotspot/hotspot-list',
    name: 'hotspotManage',
    meta: {
      title: 'hotspotManage',
      icon: 'star',
    ...
    children: [
      {
        path: 'hotspotList-manage',
        name: 'hotspotList-manage',
        component: () => import('@/views/hotspot/hotspot-list'),
        meta: { title: 'hotspotList', icon: 'user', roles: ['hot', 'primary'] }
      },
      {
        path: 'add-hotspot',
        name: 'add-hotspot',
        component: () => import('@/views/hotspot/add-hotspot'),
        meta: { title: 'addHotspot', icon: 'eye', roles: ['hot', 'primary'] }
      }
    ]
  },
  {
    ...
    meta: {
      ...
      icon: 'guide',
      roles: ['activity', 'primary']
    },
    children: [
      {
        path: 'activityList-manage',
        name: 'activityList-manage',
        component: () => import('@/views/activity/activity-list'),
        meta: { title: 'activityList', icon: 'user', roles: ['activity', 'primary'] }
      },
      {
        path: 'activity-sign',
        name: 'activity-sign',
        component: () => import('@/views/activity/activity-sign'),
        meta: { title: 'activitySign', icon: 'eye', roles: ['activity', 'primary'] }
      }
    ]
  },
  {
    ...
    children: [{
      path: 'contentList-manage',
      name: 'contentList-manage',
      component: () => import('@/views/content/content-list'),
      meta: { title: 'contentList', icon: 'peoples', roles: ['content', 'primary'] }
    }]
  },
  {
    path: '/permission',
