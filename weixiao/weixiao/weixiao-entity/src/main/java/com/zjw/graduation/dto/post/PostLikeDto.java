 ...
 */
@ApiModel(value="post.PostLikeDto", description="点赞表")
...
@ApiModelProperty(value="学生主键", name="studentId", required=true)
	 ...
	 * 内容主键
	 */
@ApiModelProperty(value="内容主键", name="contentId", required=true)
...
@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone="GMT+08:00")
	 ...
	 */
@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone="GMT+08:00")
	@ApiModelProperty(value="修改时间", name="updated", example="2019-01-01 09:01:01")
